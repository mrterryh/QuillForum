...
},{"../../modules/$.core":15}],15:[function(require,module,exports){
...
},{"_process":42,"warning":68}],22:[function(require,module,exports){
'use strict';
...
},{"_process":42,"warning":68}],25:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./DOMStateStorage":21,"./DOMUtils":22,"./ExecutionEnvironment":23,"./PathUtils":24,"./createDOMHistory":26,"_process":42,"invariant":39}],26:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":22,"./ExecutionEnvironment":23,"./createHistory":28,"_process":42,"invariant":39}],27:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./DOMStateStorage":21,"./DOMUtils":22,"./ExecutionEnvironment":23,"./PathUtils":24,"./createDOMHistory":26,"_process":42,"invariant":39,"warning":68}],28:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./AsyncUtils":20,"./PathUtils":24,"./createLocation":29,"./deprecate":31,"./runTransitionHook":35,"_process":42,"deep-equal":16,"warning":68}],29:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./PathUtils":24,"_process":42,"warning":68}],30:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./Actions":19,"./PathUtils":24,"./createHistory":28,"_process":42,"invariant":39,"warning":68}],31:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":42,"warning":68}],32:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./deprecate":31,"./useBeforeUnload":37}],33:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./deprecate":31,"./useQueries":38}],34:[function(require,module,exports){
'use strict';
...
},{"./Actions":19,"./createBrowserHistory":25,"./createHashHistory":27,"./createLocation":29,"./createMemoryHistory":30,"./deprecate":31,"./enableBeforeUnload":32,"./enableQueries":33,"./useBasename":36,"./useBeforeUnload":37,"./useQueries":38}],35:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":42,"warning":68}],36:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./ExecutionEnvironment":23,"./PathUtils":24,"./deprecate":31,"./runTransitionHook":35,"_process":42,"warning":68}],37:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":22,"./ExecutionEnvironment":23,"./deprecate":31,"_process":42,"warning":68}],38:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./PathUtils":24,"./deprecate":31,"./runTransitionHook":35,"_process":42,"query-string":43,"warning":68}],39:[function(require,module,exports){
(function (process){
/**
...
},{"../promise":63}],49:[function(require,module,exports){
/**
 * XMLHttp client.
 */
...
},{"../promise":63}],50:[function(require,module,exports){
/**
...
},{"./client/default":47,"./interceptor":55,"./interceptor/before":52,"./interceptor/cors":53,"./interceptor/header":54,"./interceptor/jsonp":56,"./interceptor/method":57,"./interceptor/mime":58,"./interceptor/timeout":59,"./promise":63}],51:[function(require,module,exports){
/**
 * Install plugin.
 */
...
},{"./http":50,"./lib/util":62,"./promise":63,"./resource":64,"./url":65}],52:[function(require,module,exports){
/**
 * Before Interceptor.
 */
...
},{"../client/jsonp":48}],54:[function(require,module,exports){
/**
 * Header Interceptor.
 */
...
},{"../promise":63}],56:[function(require,module,exports){
/**
 * JSONP Interceptor.
 */
...
},{"../client/jsonp":48}],57:[function(require,module,exports){
/**
...
},{"./lib/promise":60}],64:[function(require,module,exports){
/**
...
},{"./lib/url-template":61}],66:[function(require,module,exports){
...
},{"_process":42}],67:[function(require,module,exports){
...
},{"./components/bootstrap.js":71,"./form/form.js":74,"./paginator/paginator.js":75,"./vue-components/bootstrap.js":76,"bootstrap":2,"history":34,"jquery":40,"moment":41,"tether":45,"vue":66,"vue-resource":51}],70:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        handleRegisterFormSubmission: function handleRegisterFormSubmission(event) {
            event.preventDefault();
...
Vue.component('quill-register', require('./auth/register.js'));

Vue.component('quill-threadlist', require('./threadlist/threadlist.js'));
Vue.component('quill-threadlist-item', require('./threadlist/threadlist-item.js'));

},{"./auth/register.js":70,"./threadlist/threadlist-item.js":72,"./threadlist/threadlist.js":73}],72:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    events: {
        pageChanged: function pageChanged(page) {
            ...
            history.pushState({ page: page }, document.title, '?page=' + page);
        }
    },
    ...
    methods: {
        loadThreads: function loadThreads() {
            ...
            var source = this.source + '?page=' + page;
            ...
            return this.$http.get(source).then(function (response) {
                ...
                this.paginator = new QuillPaginator(response.data.data, response.data.current_page, response.data.last_page);
...
},{"./threadlist-item.js":72}],74:[function(require,module,exports){
'use strict';
...
window.QuillPaginator = function (data, currentPage, lastPage) {
    this.data = data;
...
Vue.component('quill-spinner', require('./spinner.vue'));
Vue.component('quill-pagination', require('./pagination.vue'));

Vue.component('quill-thread', require('./thread/thread.vue'));

},{"./pagination.vue":77,"./spinner.vue":78,"./thread/thread.vue":81}],77:[function(require,module,exports){
...
module.exports = {
    ...
    methods: {
        changePage: function changePage(event) {
            ...
            if (!this.linkIsActive(event.target)) this.setPage(event.target.innerHTML);
        },
        previousPage: function previousPage(event) {
            event.preventDefault();

            if (!this.linkIsDisabled(event.target)) this.setPage(this.paginator.currentPage - 1);
        },
...
},{"vue":66,"vue-hot-reload-api":46,"vueify-insert-css":67}],78:[function(require,module,exports){
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"loader-inner ball-pulse\">\n    <div></div>\n    <div></div>\n    <div></div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TerryHarvey/Documents/Sites/QuillForum/resources/assets/js/vue-components/spinner.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":66,"vue-hot-reload-api":46}],79:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n.editForm textarea {\n    margin-bottom: 10px;\n}\n")
'use strict';
...
module.exports = {
    ...
    methods: {
        handleReportClick: function handleReportClick(event) {
            var _this = this;
            ...
            setTimeout(function () {
                var message = 'Thanks for reporting this post. Our team will get\n                    onto it right away!';
        ...
        handleEditCancelClick: function handleEditCancelClick(event) {
            event.preventDefault();
        ...
        handleDeleteClick: function handleDeleteClick(event) {
            ...
            this.$http.post('/api/posts/delete', data).then(function (response) {
                var message = 'The post has been successfully deleted!';
        ...
        processEdit: function processEdit() {
            this.editing = true;
...
},{"vue":66,"vue-hot-reload-api":46,"vueify-insert-css":67}],80:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n.reply-controls {\n    margin-top: 20px;\n}\n")
'use strict';
...
module.exports = {
    ...
    methods: {
        handleReplySubmission: function handleReplySubmission(event) {
            event.preventDefault();
        ...
        handleSaveDraftButtonClick: function handleSaveDraftButtonClick(event) {
            event.preventDefault();

            if (this.reply.length < 1) return false;

            this.saveDraft();

            var message = 'Your draft has been successfully saved.\n                You can now close this window and come back to\n                finish your reply later!';

            swal('Success!', message, 'success');
        },
        loadDraft: function loadDraft() {
            var currentDrafts = this.getDrafts();
            var draft = currentDrafts[this.thread.id];
        ...
        saveDraft: function saveDraft() {
            ...
            localStorage.setItem('quill_drafts', (0, _stringify2.default)(currentDrafts));
        },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TerryHarvey/Documents/Sites/QuillForum/resources/assets/js/vue-components/thread/reply-form.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.reply-controls {\n    margin-top: 20px;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"babel-runtime/core-js/json/stringify":1,"vue":66,"vue-hot-reload-api":46,"vueify-insert-css":67}],81:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        loadPosts: function loadPosts() {
            ...
            var url = '/api/threads/posts/' + this.thread.id + '?page=' + page;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/TerryHarvey/Documents/Sites/QuillForum/resources/assets/js/vue-components/thread/thread.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./post.vue":79,"./reply-form.vue":80,"vue":66,"vue-hot-reload-api":46}]},{},[69]);
